...
export function BalanceKeysCard({ data }: BalanceKeysCardProps) {
  ...
  const transferPercentage = data?.transferStatus || 0
  ...
  return (
    <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-electric-cyan/10 to-electric-green/10 hover:shadow-xl transition-all duration-300 hover:scale-105">
      ...
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <CardTitle className="text-sm font-medium text-gray-700 dark:text-gray-300">Transferred Keys</CardTitle>
      ...
      <CardContent>
        ...
        <div className="mt-4 space-y-3">
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="font-medium">{transferPercentage.toFixed(1)}%</span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mt-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-sm font-medium text-electric-green">{transferredKeys.toLocaleString()}</div>
